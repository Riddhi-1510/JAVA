...
public class HashMapJ {
    public static void main(String[] args) {
        ...
        System.out.println(map.keySet());//print only keys...
        System.out.println(map.values());//print only values of key...

        //entryset...
        System.out.println(map.entrySet());//print like array
