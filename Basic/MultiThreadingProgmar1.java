public class MultiThreadingProgmar1 {
    public static void main(String[] args) {
        ...
        Thread t3 = new Thread(()->{
            System.out.println("Thead t3 is running...");
        });

        System.out.println(t1);
        System.out.println(t2);
        System.out.println(t3);
        //default all thread priority is 5 but.... we change the priority..
        //using setPriority() function
        t2.setPriority(10);
    }
}
